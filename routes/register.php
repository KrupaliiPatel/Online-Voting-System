    ...
    <div class="container">
        ...
        <form action="../api/register.php" method="POST"  enctype="multipart/form-data" autocomplete=off>
            ...
            <div class="form-item">
                ...
                <input type="number" name="vid" placeholder="Enter Voterid" required>
            </div>
            ...
            <div class="form-item">
                ...
                <input type="password" name="cpass" id="pass" placeholder="Enter Confirm Password" required>
            ...
            <div class="form-item">
                <span class="material-icons-outlined">
                   image
                    ...
                    <div id="upload" >
                       <input type="file" id="profile" name="image" style="color: rgba(122, 123, 116, 0.72);" required>
                    </div>
            </div>

            <select id="role" name="role" style="width: 30%;border: 2px solid white" required>
                <option value="1">Voter</option>
                <option value="2">Group</option>
            </select> 
            <button type="submit" id="loginbtn"name="registerbtn" style="font-size:17px"> Register </button>
            <p style="font-size:14px">Already have an account? <a href="login.php" style="color: yellow; style="font-size:14px""><u> <b> Login Here </b></u></a></p>
        </form>
